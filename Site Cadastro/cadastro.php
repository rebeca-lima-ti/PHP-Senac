...
// VERIFICAR SE TEM UM ID NO GET, SE TIVER, BUSCAR OS DADOS DO USUÁRIO
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    if (!is_numeric($id)) {
        $erro = "ID inválido, não fique mexendo nele seu salafrário.";
    }
    else {
...
<body>
    <div class="container my-4">
        ...
        <?php
            if($mensagem != "") {
                echo ("<div class='alert alert-success my-3' role='alert'>$mensagem</div>");
            }

            if($erro != "") {
                echo ("<div class='alert alert-danger my-3' role='alert'>$erro</div>");
            }
        ?>
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="nome" class="form-control" type="text" name="nome" required minlength="5" maxlength="250" value="<?php echo($nome) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="nascimento" name="nascimento" min="1900-01-01" required value="<?php echo($nascimento) ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" minlength="15" maxlength="100" required value="<?php echo($email) ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="login" name="login" minlength="4" maxlength="20" required value="<?php echo($login) ?>">
                        <div class="invalid-feedback">
                            Informe um login
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="senha" name="senha" required minlength="8" maxlength="16" value="<?php echo($senha) ?>">
                        <div class="invalid-feedback">
